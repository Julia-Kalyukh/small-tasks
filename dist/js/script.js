...
function createContent(id, title, text) {
  var html = "<div class=\"content\" id=\"".concat(id, "\">\n                <h2 class=\"content__title\">").concat(title, "</h2>\n                <div class=\"content__text\">\n                  ").concat(text, "\n                </div>\n                <input type=\"checkbox\" class=\"content__checkbox content__checkbox--").concat(id, "\">\n              </div>");
  document.querySelector('.main').innerHTML += html;
}
"use strict";

function darkThemeAdd() {
  var contentBox = document.querySelectorAll('.content');
  contentBox.forEach(function (item) {
    var checkbox = item.querySelector('.content__checkbox');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch('https://jsonplaceholder.typicode.com/posts/?_start=0&_limit=7');
          case 3:
...
function startDownload() {
  ...
  var searchParams = url.get("search");
  if (searchParams) {
...
function launchSearchValue() {
  var search = document.querySelector('.search__input'),
    value = search.value,
    newurl = window.location.protocol + "//" + window.location.host + window.location.pathname + "?search=".concat(value);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            searchData.forEach(function (t) {
              var idr = t.id,
                titler = t.title,
                textr = t.body;
              var titleSearch = titler.includes(valueSearch);
              if (titleSearch) {
