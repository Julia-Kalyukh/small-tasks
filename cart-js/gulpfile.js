...
gulp.task('server', function() {
    ...
    gulp.watch('src/media/**/*.svg',{usePolling: true}, gulp.series('icons', 'html', refresh));
    gulp.watch('src/media/**/*.{png,jpg}',{usePolling: true}, gulp.series('images', 'html', refresh));
});
...
gulp.task('images', function() {
    return gulp.src("src/media/images/**/*.{png,jpg,svg}")
